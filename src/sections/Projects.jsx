...
/* Featured Card - isolated hover state */
const FeaturedCard = memo(({ project, isInView }) => {
            ...
            <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="relative aspect-video lg:aspect-auto overflow-hidden bg-gradient-to-br from-white/10 via-white/5 to-transparent">
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="relative">
                            <div
                                className="text-white/[0.06] text-[10rem] font-heading font-bold leading-none select-none transition-transform duration-500"
                                style={{ transform: hovered ? 'scale(1.05) rotate(-2deg)' : 'scale(1) rotate(0deg)' }}
                            >
                                LVM
                            </div>
                            <div
                ...
                <div className="p-8 lg:p-10 flex flex-col justify-between">
                    <div>
                        ...
                        {/* Key Highlights — pure CSS stagger via nth-child */}
...
/* Project Card - each card owns its own hover state (no shared state cascading re-renders) */
    ...
    return (
        ...
        >
            ...
            <div className="relative aspect-video overflow-hidden bg-gradient-to-br from-white/10 to-white/5">
                <div className="absolute inset-0 flex items-center justify-center">
                    <div
                        className="text-white/[0.07] text-7xl font-heading font-bold select-none transition-transform duration-300"
                ...
                {/* Hover Overlay — pure CSS opacity transition */}
                <div
                    className="absolute inset-0 bg-black/85 backdrop-blur-sm flex items-center justify-center gap-3 transition-opacity duration-300"
